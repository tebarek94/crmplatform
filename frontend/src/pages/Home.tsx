      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center mb-8">
            <h2 className="text-3xl font-bold text-gray-800">{t('latestArticles')}</h2>
            <Link
              to="/articles"
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-gray-800 mb-2">{t('richContent')}</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-gray-800 mb-2">{t('community')}</h3>
              <p className="text-gray-600">
                {t('communityDesc')}
              </p>
            </div>
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-gray-800 mb-2">{t('easyToUse')}</h3>
              <p className="text-gray-600">
                {t('easyToUseDesc')}
              </p>
            </div>
